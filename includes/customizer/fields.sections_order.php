...
$wp_customize->add_setting( 'blesk_sections_order_one', array('sanitize_callback' => 'blesk_sanitize_section_order', 'default' => '01featured_posts'));			
...
$wp_customize->add_setting( 'blesk_sections_order_two', array('sanitize_callback' => 'blesk_sanitize_section_order', 'default' => '02wide_banner'));			
...
$wp_customize->add_setting( 'blesk_sections_order_three', array('sanitize_callback' => 'blesk_sanitize_section_order', 'default' => '03content_and_sidebar'));			
...
$wp_customize->add_setting( 'blesk_sections_order_four', array('sanitize_callback' => 'blesk_sanitize_section_order', 'default' => '04bottom_categories'));			
