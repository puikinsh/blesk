...
$wp_customize->add_setting( 'blesk_featured_count', array('sanitize_callback' => 'blesk_sanitize_text', 'default' => get_option('posts_per_page')));			
...
$wp_customize->add_setting( 'blesk_gome_central_ad', array('sanitize_callback' => 'blesk_sanitize_text', 'transport' =>'postMessage'));			
...
$wp_customize->add_setting( 'blesk_home_post_count', array('sanitize_callback' => 'blesk_sanitize_text', 'default' => get_option('posts_per_page')));			
